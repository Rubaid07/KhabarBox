...
export default function MyMealsPage() {
  ...
  const toggleAvailability = async (meal: Meal) => {
    try {
      ...
      toast.success(
        `Meal ${meal.isAvailable ? "unavailable" : "available"} now!`,
      );
    } catch (error) {
        ...
        <div className="text-center py-16 bg-white rounded-xl border border-gray-200">
          ...
          {!searchQuery && (
            <Link
              ...
              className="bg-orange-600 text-white px-6 py-3 rounded-lg inline-flex items-center gap-2 hover:bg-orange-700"
            >
            ...
            >
              ...
              <div className="relative aspect-video bg-gray-100">
                ...
                <div className="absolute top-3 right-3 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    ...
                    className="p-2 bg-white/90 backdrop-blur-sm rounded-lg hover:bg-white transition-colors cursor-pointer"
                    title={
              ...
              <div className="p-4">
                ...
                <div className="flex gap-2 mt-4 pt-4 border-t border-gray-100">
                  <button
                    onClick={() =>
                      router.push(`/provider/dashboard/meals/edit/${meal.id}`)
                    }
                    className="flex-1 flex items-center justify-center gap-2 py-2 text-sm font-medium rounded-lg outline hover:bg-orange-50 transition-colors cursor-pointer"
                  >
                    <Edit2 className="w-4 h-4" /> Edit
                  </button>
                  <button
                    onClick={() => handleDeleteClick(meal)}
                    className="flex-1 flex items-center justify-center gap-2 py-2 text-sm font-medium text-red-600 bg-red-50 rounded-lg hover:bg-red-100 transition-colors cursor-pointer"
                  >
